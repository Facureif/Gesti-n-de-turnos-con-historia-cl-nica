...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core_app.context_processors.cliente_global',
            ],
        },
    },
]
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://postgres:funesmori999@localhost:5432/gestion_turnos',
        conn_max_age=600,
...
# Archivos media (subidos por usuarios: fotos de perfil, HC, etc.)
MEDIA_URL = 'media/'
